...
def test_reply_directly_from_share() -> None:
    ...
    assert_expected_inline(
        ...
        """\
{
    "eg": "yeah lor.. really hope so...<br>but mebbe not doing sea sports..<br>more likely spa etc..<br>hahaa<br>Wah, good way to relax!<br>C u there!!<br>Aiya!! I guess MCF should start selling member's T-shirt to support the forum, then all those going Bintan can hi to each other.",
    "src": "2007 Nov 5, Davidcks. Mycarforum, \\"Bring/Buy beer from SG to Bintan resorts?\\". https://www.mycarforum.com/forums/topic/2111034-bringbuy-beer-from-sg-to-bintan-resorts/?do=findComment&comment=2115341"
}""",
    )
...
{
    "eg": "yeah lor.. really hope so...<br>but mebbe not doing sea sports..<br>more likely spa etc..<br>hahaa<br>Wah, good way to relax!<br>C u there!!<br>Aiya!! I guess MCF should start selling member's T-shirt to support the forum, then all those going Bintan can hi to each other.",
    "src": "2007 Nov 5, Davidcks. Mycarforum, \\"Bring/Buy beer from SG to Bintan resorts?\\". https://www.mycarforum.com/forums/topic/2111034-bringbuy-beer-from-sg-to-bintan-resorts/page/4/#comment-2115341"
}""",
    )
